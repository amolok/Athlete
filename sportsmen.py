...
class Sportsmen(tk.Frame):
    """ Экран результатов спортсмена. """
    ...
    def __init__(self, parent, text):
        ...
        self.frame_cup = None
        self.frame_category = None
        self.frame_sportsman = None
    ...
    def result_sportsmen(self, cup, category, sportsman, entry_1, entry_2, entry_3, entry_4, entry_5, entry_6, entry_7,
        ...
        self.label_points["text"] = f"{entry_1} {entry_2} {entry_3} {entry_4} {entry_5} {entry_6} {entry_7}"
    ...
    # def slide_position_end(self, athlete_sportsmen):
    #     """ Перемещает все виджеты с центра направо и удаляет. """
    #
    #     pos = athlete_sportsmen.frame_sportsman.place_info()
    ...
    #         # self.frame_cup.place(relx=x + 0.05)
    #         # self.frame_category.place(relx=x + 0.05)
    #         athlete_sportsmen.frame_sportsman.place(relx=x + 0.05)
    #         # self.frame_total.place(relx=x + 0.05)
    #         # self.frame_position.place(relx=x + 0.05)
    #         # self.frame_points.place(relx=x + 0.05)
    #         athlete_sportsmen.after(10, athlete_sportsmen.slide_position_end)
    #
    #     else:
